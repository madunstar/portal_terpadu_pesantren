 ...
 <aside class="bg-black aside-md hidden-print" id="nav">
        <section class="vbox">
              ...
              <nav class="nav-primary hidden-xs">
                ...
                <ul class="nav nav-main" data-ride="collapse">
                  <li  class="<?= (($menu == "orangtua") && ($submenu == 'dashboard')) ? "active" : ""; ?>">
                    <a href="<?php echo base_url() ?>orangtua/portal_ortu/dashboard" class="auto">
                  ...
                  <li class="<?= (($menu == "orangtua") && ($submenu == 'biodata'))  ? "active" : ""; ?>">
                    <a href="<?php echo base_url() ?>orangtua/portal_ortu/biodata" class="auto">
                      <i class="fa fa-user">
                      </i>
                      <span class="font-bold">Biodata Santri</span>
									...
									<li class="<?= (($menu == "orangtua") && ($submenu == 'prestasidanpelanggaran'))  ? "active" : ""; ?>">
										<a href="<?php echo base_url() ?>orangtua/portal_ortu/prestasidanpelanggaran" class="auto">
                  ...
                  <li class="<?= (($menu == "orangtua") && ($submenu == 'statusperizinan'))  ? "active" : ""; ?>">
                    <a href="<?php echo base_url() ?>orangtua/portal_ortu/statusperizinan" class="auto">
                      <span class="pull-right text-muted">
                      </span>
                  ...
                  <li class="<?= (($menu == "orangtua") && ($submenu == 'databayarinfaq'))  ? "active" : ""; ?>">
                    <a href="<?php echo base_url() ?>orangtua/portal_ortu/databayarinfaq" class="auto">
                      <span class="pull-right text-muted">
                      </span>
                      <i class="fa fa-money">
                      </i>
                  ...
                  <li class="<?= (($menu == "orangtua") && ($submenu == 'informasi'))  ? "active" : ""; ?>" >
                    <a href="<?php echo base_url() ?>orangtua/portal_ortu/informasi" class="auto">
                      <span class="pull-right text-muted">
          ...
          <footer class="footer hidden-xs no-padder text-center-nav-xs">
            <a href="<?php echo base_url() ?>orangtua/portal_ortu/logout" class="btn btn-icon icon-muted btn-inactive pull-right m-l-xs m-r-xs hidden-nav-xs">
