<section id="content">
  <section class="vbox">
    <section class="scrollable padder">
	  ...
	  <div class="row">
	    <div class="col-sm-12">
		  <?php echo form_open('master_data_c/dt_pkj/add'); ?>
            ...
            <section class="panel panel-default">
			  ...
			  <div class="panel-body">
			    <div class="form-group">
				  ...
				  <input data-required="true" class="form-control" type="text" name="kd_pkj" value="<?php echo $this->input->post('kd_pkj'); ?>" />
				  <span class="text-danger"><?php echo form_error('kd_pkj');?></span>
				</div>
				<div class="form-group">
				  <label>Nama Pekerjaan :</label>
				  <input data-required="true" class="form-control"type="text" name="nama_pkj" value="<?php echo $this->input->post('nama_pkj'); ?>" />
