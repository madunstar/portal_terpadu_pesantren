  ...
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      <?php pesan_get('msg',"Berhasil Mengubah Kata Sandi","Gagal Mengubah Kata Sandi") ?>
       ...
       <a href="<?php echo base_url('santri/pendaftaran/dashboard') ?>" style="color:#3b994a;margin-left:10px"><i class="fa fa-chevron-left"></i> Kembali</a>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label class="col-lg-4 control-label">Email Santri</label>
              <div class="col-lg-8">
                <input type="text" class="form-control" name="email_pendaftar" data-required="true" value="<?php echo $data['email_pendaftar']; ?>" readonly/>
              </div>
            </div>
            <div class="form-group">
      ...
      &nbsp
      <a href="<?php echo base_url() ?>santri/pendaftaran/ubahsandisantri?email_pendaftar=<?php echo $data['email_pendaftar']; ?>" class="btn btn-default btn-s-xs"><i class="fa fa-refresh"></i > Atur Ulang</a>
      </footer>
      </form>
