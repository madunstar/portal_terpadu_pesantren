		...
		<section class="scrollable padder">
			...
			<section class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?php if ($cekberkas =="diverifikasi") $pesan='1'; else $pesan='2'; ?>
					<?php pesanvar($pesan,"Tidak bisa mengubah berkas, berkas sudah diverifikasi","Gagal Mengupdate Biodata","Lengkapi berkas wajib dengan data sebenarnya dan selengkap-lengkapnya") ?>
                ...
                <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>santri/pendaftaran/berkas"
      					method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input <?php if ($cekberkas =="diverifikasi") echo "disabled" ?>  type="file" class="filestyle" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline v-middle input-s"
										name="file_berkas" data-required="true" id=""> <button <?php if ($cekberkas =="diverifikasi") echo "disabled" ?> type="submit" class="btn btn-success btn-s-xs"> <i class="fa fa-save"></i> Simpan</button>
