...
<body class="" >
      ...
      <section class="hbox stretch">
        ...
        <section id="content">
          <section class="vbox">
                  ...
                  <table class="table table-striped" id="role_admin">
                    <thead>
                      <tr>
  ...
  <script type="text/javascript" src="<?php echo base_url('assets/js/jquery.min.js');?>"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/js/slimscroll/jquery.slimscroll.min.js');?>"></script>

    <script type="text/javascript" src="<?php echo base_url('assets/js/datatables/jquery.dataTables.js');?>"></script>

    <script type="text/javascript" src="<?php echo base_url('assets/js/app.plugin.js');?>"></script>
