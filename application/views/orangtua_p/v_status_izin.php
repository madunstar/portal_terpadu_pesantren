        ...
        <div class="col-sm-12">
          <section class="panel panel-default">
            ...
            <header class="panel-heading">
              <h4 class="font-bold">Data Perizinan <?php echo $santri['nama_lengkap']?> / <?php echo $santri['nis_lokal']?></h4>
            </header>
            ...
            <section class="panel panel-default">
              ...
              <header class="panel-heading">
                <h4 class="font-bold">Data Denda <?php echo $santri['nama_lengkap']?> / <?php echo $santri['nis_lokal']?></h4>
              </header>
              <div class="panel-body">
