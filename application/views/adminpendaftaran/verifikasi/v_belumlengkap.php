                ...
                foreach($data->result_array() as $row){
                  echo "
                    <tr>
                      ...
                      <td>
                        <a href='".base_url('admin/pendaftaran/semuabiodata?email='.$row['email_pendaftar'].'')."'  title='Ubah'>
                      ...
                      <td>
                        <a href='".base_url('admin/pendaftaran/semuaberkas?email='.$row['email_pendaftar'].'')."'  title='Ubah'>
