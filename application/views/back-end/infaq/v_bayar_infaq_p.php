            ...
            <div class="panel-body">
                ...
                <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/datamaster/bayarinfaqp" method="post">
                  ...
                  <footer class="panel-footer text-right">
                    <a href="<?php echo base_url() ?>admin/datamaster/detilinfaqp?nis=<?php echo $nissantri?>"><button type="button" class="btn btn-s-xs btn-default"><i class="fa fa-list"></i> Data Pembayaran</button></a>
