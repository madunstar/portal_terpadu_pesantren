  ...
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      <?php pesan_get('msg',"Berhasil Mengubah Kata Sandi","Gagal Mengubah Kata Sandi") ?>
       ...
       <a href="<?php echo base_url('admin/santriakd') ?>" style="color:#3b994a;margin-left:10px"><i class="fa fa-chevron-left"></i> Kembali</a>
        <div class="row">
          <div class="col-md-6">
      ...
      &nbsp
      <a href="<?php echo base_url() ?>admin/santriakd/ubahsandiadmin?nama_akun=<?php echo $data['nama_akun']; ?>" class="btn btn-default btn-s-xs"><i class="fa fa-refresh"></i > Atur Ulang</a>
      </footer>
      </form>
