  ...
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      <?php pesan_get('msg',"Berhasil Mengubah Data Santri","Gagal Mengubah Data Santri") ?>
       <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/santriakd/santriedit?nis=<?php if (isset($nis_lokal2)) echo $nis_lokal2; else echo $data['nis_lokal']; ?>" method="post"   enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
              <input class="datepicker-input form-control" size="16" type="text"  data-date-format="dd-mm-yyyy" name="tgl_lahir"  value="<?php echo tanggal($data['tgl_lahir']); ?>" readonly/>
              </div>
            </div>
            <div class="form-group">
      ...
      &nbsp
      <a href="<?php echo base_url() ?>admin/santriakd/santriedit?nis=<?php if (isset($nis_lokal2)) echo $nis_lokal2; else echo $data['nis_lokal']; ?>" class="btn btn-default btn-s-xs"><i class="fa fa-refresh"></i > Atur Ulang</a>
      &nbsp
      <a href="<?php echo base_url('admin/santriakd/santri') ?>" class="btn btn-default btn-s-xs"><i class="fa fa-list"></i> Daftar Santri</a>
      </footer>
      </form>
