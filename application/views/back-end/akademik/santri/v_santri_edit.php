...
<section class="vbox">
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      &nbsp
      <a href="<?php echo base_url() ?>admin/santriakd/santriedit?nis=<?php if (isset($nis_lokal2)) echo $nis_lokal2; else echo $data['nis_lokal']; ?>" class="btn btn-default btn-s-xs"><i class="fa fa-refresh"></i > Reset</a>
      &nbsp
