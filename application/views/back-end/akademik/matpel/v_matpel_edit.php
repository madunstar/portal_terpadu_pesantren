        ...
        <section class="scrollable padder">
            ...
            <header class="panel-heading">
              ...
              <div class="panel-body">
                ...
                <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('admin/santriakd/matpeledit?id_matpel='.$data['id_mata_pelajaran'].'') ?>"
                  method="post">
                      ...
                      <div class="col-md-6">
                        ...
                        <footer class="panel-footer text-right bg-light lter">
                          <button type="submit" class="btn btn-success btn-s-xs">
                            ...
                            &nbsp
                            <a href="<?php echo base_url('admin/santriakd/matpeledit?id_matpel='.$data['id_mata_pelajaran'].'') ?>"
