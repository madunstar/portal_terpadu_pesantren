  ...
  <section class="vbox bg-white">
    ...
    <a href="<?php echo base_url() ?>admin/santriwatiakd/printkelasafiwati?id=<?php echo $data2['id_kelas_belajar'] ?>" class="btn btn-sm btn-warning pull-right">Kembali</a>
    ...
    <section class="scrollable wrapper">
     ...
     <tr><td>Tingkat  </td><td>&nbsp : &nbsp</td><td> <?php echo $data2['tingkat'] ?> <?php echo $data2['jenjang'] ?> </td><td width="500px"> </td><td>Ketua Kelas  </td><td>&nbsp : &nbsp</td><td></td></tr> </tr>
