				...
				<div class="col-sm-12">
					<section class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/santriwatiakd/editkelasbelawati?id=<?php echo $data['id_kelas_belajar'] ?>" method="post">
