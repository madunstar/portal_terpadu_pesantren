  ...
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      <div class="table-responsive">
        ...
        <a style="margin: 10px 0 10px 0px" href="<?php echo base_url() ?>admin/santriwatiakd/datakelasbelawati" class="btn btn-s-md btn-default" ><i class="fa fa-arrow-left"></i> Kembali</a>
        <div class="row">
