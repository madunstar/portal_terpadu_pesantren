<script>
   ...
   $('#datatable').DataTable({
        "bStateSave"    : true,
        "ajax"          : {
                            url :"<?php echo base_url(); ?>admin/santriwatiakd/datakelaspondwatiajax", // json datasource
                ...
                $.confirm({
                    ...
                    buttons: {
                        hapus: {
                            ...
                            btnClass: 'btn-green',
                            action: function(){
                                window.location.assign("<?php echo base_url() ?>admin/santriwatiakd/hapuskelaspondwati?id="+v_id);
                            }
                        },
                        batal: function () {
    ...
    $(".edit").click(function(e) {
        var v_url = "<?php echo base_url() ?>admin/santriwatiakd/kelaseditpondwati";
        var v_id = this.id;
        $.ajax({
				type: 'POST',
				url: v_url,
                ...
                complete: function () {
                    $('#editpondokanproses').click(function (e) {
                        var v_url = "<?php echo base_url() ?>admin/santriwatiakd/editpondwatiproses";
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                window.location.assign("<?php echo base_url() ?>admin/santriwatiakd/datakelaspondwati?ed=1")
                            }
                        });
