				...
				<div class="col-sm-12">
					<section class="panel panel-default">
						...
						<div class="panel-body">
							<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/santriwatiakd/editkelaspondwati?id=<?php echo $data['id_kelas_belajar'] ?>"
							method="post">
								<div class="row">
									<div class="col-sm-12">
										<div class="row">
									...
									<div class="col-sm-12">
											...
											<div class="text-center" style="margin-bottom:10px">
												<a href="<?php echo base_url() ?>admin/santriwatiakd/lihatkelaspondokansantriwati?id=<?php echo $data['id_kelas_belajar'] ?>" class="btn btn-default" margin="auto"><i class="fa fa-edit"></i> Edit Daftar Santri</a>
											</div>
								...
								<footer class="panel-footer text-right bg-light lter">
									<a href="<?php echo base_url() ?>admin/santriwatiakd/editkelaspondwati?id=<?php echo $data['id_kelas_belajar'] ?>" type="submit" class="btn btn-success btn-s-xs">
