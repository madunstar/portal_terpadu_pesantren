  ...
  <section class="vbox bg-white">
    <header class="header b-b b-light hidden-print">
      <a href="<?php echo base_url() ?>admin/santriwatiakd/datarekapsantripondokan?kelas=<?php echo $kelas ?>&pelajaran=<?php echo $pelajaran ?>&tanggal=<?php echo $tanggal ?>" class="btn btn-sm btn-warning pull-right">Kembali</a>
    ...
    <section class="scrollable wrapper">
      ...
      <div class="well b bg-light m-t">
        <div class="row">
          <div class="col-xs-3">
            <p>
              Total santriwati Hadir <br><br>
              Total santriwati Izin  <br><br>
              Total santriwati Sakit  <br><br>
              Total santriwati Alfa  <br><br>
            </p>
          </div>
          <div class="col-xs-3">
            <p>
