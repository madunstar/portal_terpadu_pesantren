		...
		<section class="scrollable padder">
			...
			<section class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/santriakd/guruedit?nip=<?php if (isset($nip_guru2)) echo $nip_guru2; else echo $data['nip_guru']; ?>"
              ...
              <div class="col-sm-8">
				...
				<footer class="panel-footer text-right bg-light lter">
					...
					&nbsp
					<a href="<?php echo base_url() ?>admin/santriakd/guruedit?nip=<?php if (isset($nip_guru2)) echo $nip_guru2; else echo $data['nip_guru']; ?>"
