<script>
 $('#datatable').DataTable({
        "bStateSave"    : true,
        "ajax"          : {
                            url :"<?php echo base_url(); ?>admin/santriakd/datakelasbelajarajax", // json datasource
    ...
    $.confirm({
        ...
        buttons: {
            hapus: {
                ...
                btnClass: 'btn-green',
                action: function(){
                    window.location.assign("<?php echo base_url() ?>admin/santriakd/hapuskelasbelajar?id="+v_id);
                }
            },
            batal: function () {
    ...
    $(".edit").click(function(e) {
        var v_url = "<?php echo base_url() ?>admin/santriakd/kelaseditbelajar";
        var v_id = this.id;
        $.ajax({
				type: 'POST',
				url: v_url,
                ...
                complete: function () {
                    $('#editkelasproses').click(function (e) {
                        var v_url = "<?php echo base_url() ?>admin/santriakd/editkelasproses";
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                window.location.assign("<?php echo base_url() ?>admin/santriakd/datakelasbelajar?ed=1")
                            }
                        });
