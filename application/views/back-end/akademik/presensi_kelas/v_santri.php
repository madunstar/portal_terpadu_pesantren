...
<section class="vbox">
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      <a style="margin: 10px 0 10px 0px" href="<?php echo base_url() ?>admin/santriakd/lihatkelasbelajarsantri" class="btn btn-s-md btn-default" ><i class="fa fa-arrow-left"></i> Kembali</a>
