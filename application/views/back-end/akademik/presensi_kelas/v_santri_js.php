<script>
   ...
   $(".hapus").click(function (e) {
    ...
    $.confirm({
        ...
        buttons: {
            hapus: {
                ...
                btnClass: 'btn-green',
                action: function(){
                    window.location.assign("<?php echo base_url() ?>admin/santriakd/hapuskelassantri?id="+v_id+"&idkelas="+v_idkelasbelajar);
                }
            },
            batal: function () {
    ...
    $("#tambahsantri").click(function(e) {
        var v_url = "<?php echo base_url() ?>admin/santriakd/kelastambahsantri";
        var v_idkelasbelajar = "<?php echo $santri['id_kelas_belajar'] ?>";
        $.ajax({
				type: 'POST',
				url: v_url,
                    ...
                    $('#tambahsantriproses').click(function (e) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                $("#myModal").hide();
                                window.location.assign("<?php echo base_url() ?>admin/santriakd/lihatkelasbelajarsantri?id=<?php echo $santri['id_kelas_belajar'] ?>&msg=1")
                                //isidata();
    ...
    $(".editsantri").click(function(e) {
        var v_url = "<?php echo base_url() ?>admin/santriakd/kelaseditsantri";
        var v_idkelasbelajar = "<?php echo $santri['id_kelas_belajar'] ?>";
        var v_id = this.id;
        $.ajax({
				type: 'POST',
                ...
                complete: function () {
                    $('#editsantriproses').click(function (e) {
                        var v_url = "<?php echo base_url() ?>admin/santriakd/editsantriproses";
                        var v_idkelasbelajar = "<?php echo $santri['id_kelas_belajar'] ?>";
                        var v_nis = $('#nis_lokal').val();
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                $('body').css('padding-right', '');
                                $("#myModal").hide();
                                window.location.assign("<?php echo base_url() ?>admin/santriakd/lihatkelasbelajarsantri?id=<?php echo $santri['id_kelas_belajar'] ?>&ed=1")
                                //isidata();
                                //pesanpop('Pesan !', 'Berhasil menambah data Gudang.', 'success')
                            }
                        });
