		...
		<section class="scrollable padder">
			...
			<section class="panel panel-default">
				...
				<div class="panel-body">
					<?php pesan_get('msg',"Berhasil Mengedit Data Berkas santriwati","Gagal Mengedit Data Berkas santriwati") ?>
					<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/santriwatiakd/santriwatieditberkas?id=<?php echo $data['id_berkas'] ?>&nis=<?php echo $santriwati['nis_lokal'] ?>"
