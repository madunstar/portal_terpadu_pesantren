    ...
    <section class="scrollable padder">
      ...
      <section class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('admin/santriakd/kelasedit?kd_kelas='.$data['kd_kelas'].'') ?>"
            method="post">
            <a href="<?php echo base_url('admin/santriakd/kelas') ?>" style="color:#3b994a;margin-left:10px">
            ...
            <footer class="panel-footer text-right bg-light lter">
              <button type="submit" class="btn btn-success btn-s-xs">
                ...
                &nbsp
                <a href="<?php echo base_url('admin/santriakd/kelasedit?kd_kelas='.$data['kd_kelas'].'') ?>"
                  class="btn btn-default btn-s-xs">
                  <i class="fa fa-refresh"></i> Reset</a>
                  &nbsp
                  <a href="<?php echo base_url('admin/santriakd/kelas') ?>" class="btn btn-default btn-s-xs">
