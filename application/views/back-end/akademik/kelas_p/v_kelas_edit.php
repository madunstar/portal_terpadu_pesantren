    ...
    <section class="scrollable padder">
      ...
      <section class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('admin/santriwatiakd/kelasedit?kd_kelas='.$data['kd_kelas'].'') ?>"
            method="post">
            ...
            <footer class="panel-footer text-right bg-light lter">
              <button type="submit" class="btn btn-success btn-s-xs">
                ...
                &nbsp
                <a href="<?php echo base_url('admin/santriwatiakd/kelasedit?kd_kelas='.$data['kd_kelas'].'') ?>"
