                    ...
                    foreach($data->result_array() as $row){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>
                          <a href='".base_url('admin/santriakd/lihatkelaspondokan?id='.$row['id_kelas_belajar'].'')."' class='btn btn-success btn-xs' title='Lihat'><i class='fa fa-eye'></i></a>
						  ...
						  <td>".$row['tingkat']."</td>
						  <td><a href='".base_url('admin/santriakd/jadwalpondokan?id='.$row['id_kelas_belajar'].'')."' class='btn btn-success btn-xs' title='Lihat'><i class='fa fa-clock-o'></i> Jadwal</a></td>
                          ...
                          <td><a href='".base_url('admin/santriakd/lihatkelaspondokansantri?id='.$row['id_kelas_belajar'].'')."' class='btn btn-success btn-xs' title='Lihat'><i class='fa fa-list'></i> Santri</a></td>
                        </tr>
                      ";
                    }
                ?>
