		...
		<section class="scrollable padder">
			...
			<section class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/santriwatiakd/santriwatieditberkas?id=<?php echo $data['id_berkas'] ?>&nis=<?php echo $santri['nis_lokal'] ?>"
					method="post" enctype="multipart/form-data">
					<a href="<?php echo base_url('admin/santriwatiakd/santriwatiberkas?nis='.$santri['nis_lokal'].'') ?>" style="color:#3b994a;margin-left:10px"><i class="fa fa-chevron-left"></i> Kembali</a>
						<div class="row">
							<div class="col-md-12">
				...
				<footer class="panel-footer text-right bg-light lter">
					...
					&nbsp
					<a href="<?php echo base_url('admin/santriwatiakd/santriwatiberkas?nis='.$santri['nis_lokal'].'') ?>" class="btn btn-default btn-s-xs">
