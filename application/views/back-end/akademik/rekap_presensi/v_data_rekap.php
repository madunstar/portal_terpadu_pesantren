...
<section class="vbox">
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/santriakd/datarekapsantri" method="post">
                     ...
                     <div class='modal-dialog' role='document'>
                       <div class='modal-content'>
                         ...
                         <div class='modal-footer'>
                           <a style='margin-left:5px' href='".base_url('admin/santriakd/hapusrekap?id='.$row['id_rekap'].'&kelas='.$kelas.'&pelajaran='.$pelajaran.'&tanggal='.$tanggal.'')."'>
      ...
      <footer class="panel-footer text-right">
        <a href="<?php echo base_url() ?>admin/santriakd/pelajaranrekap" type="button" class="btn btn-default" name="button"><i class="fa fa-list"></i> Daftar Pelajaran</a>
        <a href="<?php echo base_url() ?>admin/santriakd/laporanrekapharian?kelas=<?php echo $kelas ?>&pelajaran=<?php echo $pelajaran ?>&tanggal=<?php echo $tanggal ?>" type="button" class="btn btn-primary" name="button"><i class="fa fa-print"></i> Cetak Rekap Harian</a>
      </footer>
    </section>
    <!-- ini tambah data -->
     ...
     <div class='modal-dialog' role='document'>
       <div class='modal-content'>
         ...
         <div class='modal-body'>
           ...
           ?>
                  <form class="form-horizontal mb-lg" action="<?php echo base_url() ?>admin/santriakd/tambahrekap" method="post">
                    <div class="form-group">
