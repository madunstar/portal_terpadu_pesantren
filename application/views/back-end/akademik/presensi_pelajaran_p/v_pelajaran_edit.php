    ...
    <section class="scrollable padder">
      ...
      <section class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('admin/santriwatiakd/pelajaranedit?id_pelajaran='.$data['id_pelajaran'].'') ?>"
            method="post">
            ...
            <footer class="panel-footer text-right bg-light lter">
              <button type="submit" class="btn btn-success btn-s-xs">
                ...
                &nbsp
                <a href="<?php echo base_url('admin/santriwatiakd/pelajaranedit?id_pelajaran='.$data['id_pelajaran'].'') ?>"
