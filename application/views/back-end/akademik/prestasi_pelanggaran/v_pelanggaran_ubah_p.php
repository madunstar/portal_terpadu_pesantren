<section id="content">
	<section class="vbox">
		<section class="scrollable padder">
			<div class="m-b-md">
				<h3 class="m-b-none">Pelanggaran santriwati</h3>
			</div>
			<section class="panel panel-default">
				<header class="panel-heading">
					Ubah Pelanggaran  <?php echo $santriwati['nama_lengkap']?> / <?php echo $santriwati['nis_lokal']?>
				</header>
				<div class="panel-body">
					<?php pesan_get('msg',"Berhasil Mengubah Pelanggaran","Gagal Mengubah Pelanggaran") ?>
					<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/santriwatiakd/ubahpelanggaranp"
					method="post">
						<a href="<?php echo base_url('admin/santriwatiakd/pelanggaransantriwati?nis='.$data['nis_santri'].'') ?>" style="color:#3b994a;margin-left:10px">
				...
				<footer class="panel-footer text-right bg-light lter">
					...
					&nbsp;
					<a href="<?php echo base_url() ?>admin/santriwatiakd/ubahpelanggaranp?id=<?php if (isset($id_pelanggaranlama)) echo $id_pelanggaranlama;
						 ...
						 &nbsp;
					<a href="<?php echo base_url('admin/santriwatiakd/pelanggaransantriwati?nis='.$data['nis_santri'].'') ?>" class="btn btn-default btn-s-xs">
