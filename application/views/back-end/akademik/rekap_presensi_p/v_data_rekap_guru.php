  ...
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
                     ...
                     <div class='modal-dialog' role='document'>
                       <div class='modal-content'>
                         ...
                         <div class='modal-footer'>
                           <a style='margin-left:5px' href='".base_url('admin/santriwatiakd/hapusrekapguru?id='.$row['id_rekap'].'&kelas='.$kelas.'&pelajaran='.$pelajaran.'&tanggal='.$tanggal.'&guru='.$nip_guru.'')."'>
      ...
      <footer class="panel-footer text-right">
        ...
        <a href="<?php echo base_url() ?>admin/santriwatiakd/laporanrekapguru?kelas=<?php echo $kelas ?>&pelajaran=<?php echo $pelajaran ?>&tanggal=<?php echo $tanggal ?>&guru=<?php echo $nip_guru ?>" type="button" class="btn btn-primary" name="button"><i class="fa fa-print"></i> Cetak Rekap Kehadiran</a>
      </footer>
    </section>
    <!-- ini tambah data -->
    <div class='modal' id='tambahdata' tabindex='-1' role='dialog'>
     ...
     <div class='modal-dialog' role='document'>
       <div class='modal-content'>
         ...
         <div class='modal-body'>
                  <form class="form-horizontal mb-lg" data-validate="parsley" action="<?php echo base_url() ?>admin/santriwatiakd/tambahrekapguru" method="post">
