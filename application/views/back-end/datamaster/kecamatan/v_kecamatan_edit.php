...
<section class="vbox">
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      &nbsp
      <a href="<?php echo base_url() ?>admin/datamaster/kecamatanedit?id_kecamatan=<?php echo $data['id_kecamatan']; ?>&id_provinsi=<?php echo $data['id_provinsi']; ?>" class="btn btn-default btn-s-xs"><i class="fa fa-refresh"></i > Atur Ulang</a>
      &nbsp
