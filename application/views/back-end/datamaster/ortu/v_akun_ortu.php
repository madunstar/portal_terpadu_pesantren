            ...
            <?php
                foreach($data->result_array() as $row){ ?>
                    <tr>
                      ...
                      <td><?php echo
                          (($row['status_akun'] == 'aktif' ) ? '<a href="'.base_url("admin/datamaster/akunortunonaktif?id=".$row["nis_lokal"]."").'" class="btn btn-success btn-xs" >Aktif</a> <a href="#" class="btn btn-warning btn-xs" >Reset Sandi</a>'
