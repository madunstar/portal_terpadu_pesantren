  ...
  <section class="vbox">
    ...
    <section class="scrollable padder">
      <div class="row m-b-md">
        <div class="col-sm-6">
          <h3 class="m-b-xs text-black">Atur Besar Denda Santriwati Kembali</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-12">
          <section class="panel panel-default">
            <header class="panel-heading">
              <h4 class="font-bold">Update Data Besar Denda Santriwati Kembali</h4>
            </header>
            <div class="panel-body">
              <?php pesan_get('msg',"Berhasil Mengupdate Data Aturan Denda","Password Anda Salah","Password Anda Tidak Cocok") ?>
                <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url();?>admin/datamaster/updateaturdendap" method="post">
