        ...
        <div class="col-sm-12">
          <section class="panel panel-default">
            <header class="panel-heading">
              <h4 class="font-bold">Input Data Santriwati Keluar Pondok</h4>
            </header>
            <div class="panel-body">
              <?php pesan_get('msg',"Berhasil Menghapus Data Penjemput","Gagal Menghapus Data Penjemput") ?>
              <?php pesan_get('msgnis',"Data Santriwati Ditemukan","Data Santriwati Tidak Ditemukan!","") ?>
              <form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url('admin/datamaster/keluarp')?>" method="post">
