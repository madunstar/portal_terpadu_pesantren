  ...
  <section class="vbox">
    ...
    <section class="scrollable padder">
      <div class="row m-b-md">
        <div class="col-sm-6">
          <h3 class="m-b-xs text-black">Data Denda Santriwati</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-12">
          <section class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <button data-toggle='modal' data-target='#tambahbayar' type="button" name="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Pembayaran Denda</button> <a class="btn btn-default btn-s-xs" href="<?php echo base_url() ?>admin/datamaster/datadendap"><i class="fa fa-list"></i> List Data Denda</a><br><br>
                         ...
                         <div class='modal-dialog' role='document'>
                           <div class='modal-content'>
                             ...
                             <div class='modal-footer'>
                               <a style='margin-left:5px' href='".base_url('admin/datamaster/bayardendahapusp?id_bayar='.$row['id_bayar'].'&nis='.$row['nis_lokal'].'&id_denda='.$row['id_denda'].'')."'>
              ...
              <div class='modal' id='tambahbayar' tabindex='-1' role='dialog'>
                <form class='form-horizontal' role='form' data-validate='parsley' action='<?php echo base_url() ?>admin/datamaster/bayardendap' method='post'>
                 <div class='modal-dialog' role='document'>
                   <div class='modal-content'>
