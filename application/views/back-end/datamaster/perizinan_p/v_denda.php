            ...
            <div class="panel-body">
                    ...
                    foreach($data->result_array() as $row){
                      echo "
                        <tr>
                          ...
                          <td><a href='".base_url('admin/datamaster/riwayatbayardendap?nis='.$row['nis_lokal'].'&denda='.$row['id_denda'].'')."'><button class='btn btn-xs btn-primary'>lihat riwayat pembayaran</button></a></td>
                        </tr>
                      ";
                    }
                    ?>
              ...
              <div class="panel-footer">
                ...
                <div class='modal' id='cetaklap' tabindex='-1' role='dialog'>
                  <form class='form-horizontal' role='form' data-validate='parsley' action='<?php echo base_url() ?>admin/datamaster/laporandendap' method='post'>
