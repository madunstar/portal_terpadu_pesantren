		...
		<section class="scrollable padder">
			<div class="m-b-md">
				<h3 class="m-b-none">Pondokan Tingkat "
					<?php echo $pondokan['namapondokan'] ?> (<?php echo $pondokan['pondokan'] ?>)"</h3>
			</div>
			<section class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/datamaster/pondokantambahtingkat?pondokan=<?php echo $pondokan['pondokan'] ?>"
