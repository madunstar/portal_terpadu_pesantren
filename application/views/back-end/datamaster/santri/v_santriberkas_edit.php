		...
		<section class="scrollable padder">
			...
			<section class="panel panel-default">
				...
				<div class="panel-body">
					<?php pesan_get('msg',"Berhasil Mengubah Data Berkas Santri","Gagal Mengubah Data Berkas Santri") ?>
					<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/datamaster/santrieditberkas?id=<?php echo $data['id_berkas'] ?>&nis=<?php echo $santri['nis_lokal'] ?>"
