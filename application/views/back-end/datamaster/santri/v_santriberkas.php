...
<section class="vbox">
  <section class="scrollable padder">
    ...
    <section class="panel panel-default">
      ...
      <a style="margin: 10px 0 10px 10px" href="<?php echo base_url() ?>admin/datamaster/santritambahberkas?nis=<?php echo $santri['nis_lokal'] ?>" class="btn btn-s-md btn-success " ><i class="fa fa-plus"></i> Tambah Berkas</a> &nbsp
            ...
            <?php
                foreach($data->result_array() as $row){
                  echo "
                    <tr>
                      <td>
                      <a href='".base_url('admin/datamaster/santrieditberkas?id='.$row['id_berkas'].'&nis='.$santri['nis_lokal'].'')."' class='btn btn-success btn-xs' title='Edit'><i class='fa fa-edit'></i></a>
