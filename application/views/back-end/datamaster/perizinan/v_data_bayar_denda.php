        ...
        <div class="col-sm-12">
          <section class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <button data-toggle='modal' data-target='#tambahbayar' type="button" name="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Pembayaran Denda</button> <a class="btn btn-default btn-s-xs" href="<?php echo base_url() ?>admin/datamaster/datadenda"><i class="fa fa-list"></i> List Data Denda</a><br><br>
                         ...
                         <div class='modal-dialog' role='document'>
                           <div class='modal-content'>
                             ...
                             <div class='modal-footer'>
                               <a style='margin-left:5px' href='".base_url('admin/datamaster/bayardendahapus?id_bayar='.$row['id_bayar'].'&nis='.$row['nis_lokal'].'&id_denda='.$row['id_denda'].'')."'>
              ...
              <div class='modal' id='tambahbayar' tabindex='-1' role='dialog'>
                <form class='form-horizontal' role='form' data-validate='parsley' action='<?php echo base_url() ?>admin/datamaster/bayardenda' method='post'>
                 <div class='modal-dialog' role='document'>
                   <div class='modal-content'>
