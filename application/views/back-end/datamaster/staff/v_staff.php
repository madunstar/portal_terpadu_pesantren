                ...
                foreach($data->result_array() as $row){
                  echo "
                    <tr>
                      ...
                      <a href='".base_url('admin/datamaster/staffedit?nip='.$row['nip_staff'].'')."' class='btn btn-warning btn-xs' title='Ubah'><i class='fa fa-edit'></i></a>
                      <a href='#' class='btn btn-danger btn-xs hapus' title='Hapus' id='".$row['nip_staff']."'><i class='fa fa-trash-o'></i></a>
                      </td>
                      <td>".$row['nama_lengkap']."</td>
                      <td>".$row['nip_staff']."</td>
                      <td>".($row['jenis_kelamin']=="L"?"Laki-laki":"Perempuan")."</td>
                      <td><a href='".base_url('admin/datamaster/staffberkas?nip='.$row['nip_staff'].'')."' class='btn btn-success btn-xs' title='Berkas Staff'><i class='fa fa-file-text-o'></i> Berkas</a></td>
                    </tr>
                  ";
                }
            ?>
