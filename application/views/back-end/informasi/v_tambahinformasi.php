        ...
        <div class="col-sm-12">
          <section class="panel panel-info">
            ...
            <div class="panel-body">
              <?php pesan_get('msg',"Berhasil Menambahkan Data Informasi ","Gagal Menambahkan Data Informasi ") ?>
               <form id="myform" class="bs-example form-horizontal" data-validate="parsley"
                action="<?php echo base_url() ?>admin/datamaster/tambahinformasi" method="post">
