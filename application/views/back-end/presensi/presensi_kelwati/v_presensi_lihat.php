				...
				<div class="col-sm-12">
					<section class="panel panel-default">
						<header class="panel-heading">
							<h4 class="font-bold">Lihat Data Presensi Kelas Afilasi</h4>
						</header>
						<div class="panel-body">
							<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/datamaster/editkelasbelawati?id=<?php echo $data['id_kelas_belajar'] ?>"
							method="post">
							<a href="<?php echo base_url('admin/datamaster/datakelasbelawati') ?>" style="color:#3b994a;margin-left:10px">
								...
								<div class="row">
									...
									<div class="col-sm-12">
											...
											<div class="text-center" style="margin-bottom:10px">
												<a href="<?php echo base_url() ?>admin/datamaster/lihatkelasbelajarsantriwati?id=<?php echo $data['id_kelas_belajar'] ?>" class="btn btn-default btn-warning" margin="auto"><i class="fa fa-edit"></i> Edit Daftar Santri</a>
											</div>
								...
								<footer class="panel-footer text-right bg-light lter">
									<a href="<?php echo base_url() ?>admin/datamaster/editkelasbelawati?id=<?php echo $data['id_kelas_belajar'] ?>" type="submit" class="btn btn-warning btn-s-xs">
										<i class="fa fa-edit"></i> Ubah</a>
									&nbsp
									<a href="<?php echo base_url('admin/datamaster/datakelasbelawati') ?>" class="btn btn-default btn-s-xs">
