<script>
   ...
   $(".hapus").click(function (e) {
    ...
    $.confirm({
        ...
        buttons: {
            hapus: {
                ...
                btnClass: 'btn-green',
                action: function(){
                    window.location.assign("<?php echo base_url() ?>admin/datamaster/hapuskelasbelawati?id="+v_id);
                }
            },
            batal: function () {
    ...
    $(".edit").click(function(e) {
        var v_url = "<?php echo base_url() ?>admin/datamaster/kelaseditbelawati";
        var v_id = this.id;
        $.ajax({
				type: 'POST',
				url: v_url,
                ...
                complete: function () {
                    $('#editkelasproses').click(function (e) {
                        var v_url = "<?php echo base_url() ?>admin/datamaster/editkelasproseswati";
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                window.location.assign("<?php echo base_url() ?>admin/datamaster/datakelasbelawati?ed=1")
                            }
                        });
