                ...
                foreach($data->result_array() as $row){
                  echo "
                    <tr>
                      ...
                      <a href='".base_url('admin/datamaster/datarekapguru?pelajaran='.$row['id_pelajaran'].'&kelas='.$row['id_kelas_belajar'].'&tanggal='.$tanggal.'&jadwal='.$row['id_jadwal'].'')."' class='btn btn-success btn-xs' title='Lihat Rekap Guru'><i class='fa fa-user'></i></a>
                      </td>
