				...
				<div class="col-sm-12">
					<section class="panel panel-default">
						...
						<div class="panel-body table-responsive">
							...
							<a href="<?php echo base_url() ?>admin/datamaster/aturkelaspondwati">
                    ...
                    foreach($data->result_array() as $row){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>
                          <a href='".base_url('admin/datamaster/lihatkelaspondwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-success btn-xs' title='Lihat'><i class='fa fa-eye'></i></a>
                          <a href='".base_url('admin/datamaster/editkelaspondwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-success btn-xs' title='Edit'><i class='fa fa-edit'></i></a>
                          ...
                          <td>".$row['pondokan']."</td>
						  <td>".$row['tingkat']."</td>
						  <td><a href='".base_url('admin/datamaster/jadwalpondwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-success btn-xs' title='Lihat'><i class='fa fa-clock-o'></i> Jadwal</a></td>
                          ...
                          <td><a href='".base_url('admin/datamaster/lihatkelaspondokansantriwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-success btn-xs' title='Lihat'><i class='fa fa-list'></i> Santri</a></td>
                        </tr>
                      ";
                    }
                ?>
