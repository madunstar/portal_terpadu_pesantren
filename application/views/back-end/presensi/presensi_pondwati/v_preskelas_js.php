<script>
   ...
   $('#datatable').DataTable({
                ...
                $.confirm({
                    ...
                    buttons: {
                        hapus: {
                            ...
                            btnClass: 'btn-green',
                            action: function(){
                                window.location.assign("<?php echo base_url() ?>admin/datamaster/hapuskelaspondwati?id="+v_id);
                            }
                        },
                        batal: function () {
    ...
    $(".edit").click(function(e) {
        var v_url = "<?php echo base_url() ?>admin/datamaster/kelaseditpondwati";
        var v_id = this.id;
        $.ajax({
				type: 'POST',
				url: v_url,
                ...
                complete: function () {
                    $('#editpondokanproses').click(function (e) {
                        var v_url = "<?php echo base_url() ?>admin/datamaster/editpondwatiproses";
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                window.location.assign("<?php echo base_url() ?>admin/datamaster/datakelaspondwati?ed=1")
                            }
                        });
