        ...
        <div class="col-sm-12">
          <section class="panel panel-default">
            <header class="panel-heading">
              <h4 class="font-bold">Tambah Data Santri Bayar Denda</h4>
            </header>
            <div class="panel-body">
              <form class="bs-example form-horizontal" data-validate="parsley" action="" method="post">
                ...
                <div class="form-group">
                      <label class="col-sm-2 control-label text-danger">Besar Bayar</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="input-id-1">
                      </div>
                </div>
                  ...
                  <footer class="panel-footer text-right">
                    <button class="btn btn-sm btn-info">Proses Pembayaran&nbsp;<span class="fa fa-check"></span></button>
                  </footer>
