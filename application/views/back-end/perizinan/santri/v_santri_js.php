 ...
 $(document).ready(function(){
   ...
   $(".hapus").click(function (e) {
    ...
    $.confirm({
        ...
        buttons: {
            hapus: {
                ...
                btnClass: 'btn-green',
                action: function(){
                    window.location.assign("<?php echo base_url() ?>admin/perizinan/santriwatihapus?nis="+v_nis);
                }
            },
            batal: function () {
    ...
    $('#provinsi').change(function(){
        var id=$(this).val();
        $.ajax({
        url : "<?php echo base_url();?>admin/perizinan/datakotakab2",
        method : "POST",
        data : {provinsi: id},
        async : false,
        dataType : 'json',
    ...
    $('#kabupaten_kota').change(function(){
        var id=$(this).val();
        $.ajax({
        url : "<?php echo base_url();?>admin/perizinan/datakecamatan2",
        method : "POST",
        data : {kecamatan: id},
        async : false,
        dataType : 'json',
    ...
    $('#kecamatan').change(function(){
        var id=$(this).val();
        $.ajax({
        url : "<?php echo base_url();?>admin/perizinan/datadesa2",
        method : "POST",
        data : {desa: id},
        async : false,
        dataType : 'json',
    ...
    $(".edit").click(function(e) {
        var v_url = "<?php echo base_url() ?>admin/perizinan/santriwatitingkat";
        var v_id = this.id;
        $.ajax({
				type: 'POST',
				url: v_url,
    ...
    $(".edit2").click(function(e) {
        var v_url = "<?php echo base_url() ?>admin/perizinan/santriwatitingkatpondokan";
        var v_id = this.id;
        $.ajax({
				type: 'POST',
				url: v_url,
