        ...
        <div class="col-sm-12">
          <section class="panel panel-default">
            ...
            <div class="panel-body">
              <a href="<?php echo base_url() ?>admin/perizinansantri/kembali"><button type="button" name="button" class="btn btn-success btn-rounded"><i class="fa fa-plus"></i> Tambah Kembali ke Pondok</button></a>
            ...
            <div class="panel-footer">
              ...
              <div class='modal' id='cetaklap' tabindex='-1' role='dialog'>
                <form class='form-horizontal' role='form' data-validate='parsley' action='<?php echo base_url() ?>admin/perizinansantri/laporankembali' method='post'>
