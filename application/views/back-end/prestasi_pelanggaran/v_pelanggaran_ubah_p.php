		...
		<section class="scrollable padder">
			...
			<section class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="bs-example form-horizontal" data-validate="parsley" action="<?php echo base_url() ?>admin/datamaster/ubahpelanggaranp"
					method="post">
						<a href="<?php echo base_url('admin/datamaster/pelanggaransantriwati?nis='.$data['nis_santri'].'') ?>" style="color:#3b994a;margin-left:10px">
		       ...
		       else echo $data['id_pelanggaran']; ?>&nis=<?php echo $data['nis_santri'] ?>" class="btn btn-default btn-s-xs"><i class="fa fa-refresh"></i > Atur Ulang</a>
						 &nbsp;
