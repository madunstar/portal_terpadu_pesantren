      ...
      <div class="row">
        <div class="col-sm-12">
          <section class="panel panel-default">
            ...
            <a style="margin: 10px 0 10px 0px" href="<?php echo base_url() ?>admin/datamaster/santriwati" class="btn btn-s-md btn-default" ><i class="fa fa-list"></i> Daftar Santriwati</a>
