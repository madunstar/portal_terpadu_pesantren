      ...
      <div class="row">
        <div class="col-sm-12">
          <section class="panel panel-default">
            ...
            <a href="<?php echo base_url() ?>admin/datamaster/tambahpelanggaran?nis=<?php echo $santri['nis_lokal']?>"><button type="button" name="button" class="btn btn-success btn-rounded"><i class="fa fa-plus"></i> Tambah Pelanggaran</button></a>
