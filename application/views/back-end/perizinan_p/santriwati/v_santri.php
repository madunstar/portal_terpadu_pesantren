			...
			<section class="panel panel-default" style="width:100%">
                ...
                foreach($data->result_array() as $row){
                  echo "
                    <tr>
                      <td>
                      <a href='".base_url('admin/perizinansantriwati/santriwatilihat?nis='.$row['nis_lokal'].'')."' class='btn btn-primary btn-xs' title='Lihat'><i class='fa fa-eye'></i></a>
                      ...
                      <td>
                        <a href='".base_url('admin/perizinansantriwati/santriwatiberkas?nis='.$row['nis_lokal'].'')."' class='btn btn-success btn-xs' title='Berkas'><i class='fa fa-file-text-o'></i></a>
                      </td>
                    </tr>
                  ";
                }
 ...
 <div class='modal-dialog' role='document'>
	 <div class='modal-content'>
		 ...
		 <div class='modal-body form-horizontal'>
			 <form class="" action="<?php echo base_url() ?>admin/perizinansantriwati/santriwatiimport" method="post"  enctype="multipart/form-data">
				 ...
				 <p><small>Pastikan Format Isian File Excel Data Santri Sesusai dengan <a class="text-info" href="<?php echo base_url() ?>admin/perizinansantriwati/downloadcontohimport"><b>Contoh Berikut</b></a></small></p>
			 </form>
		 </div>
