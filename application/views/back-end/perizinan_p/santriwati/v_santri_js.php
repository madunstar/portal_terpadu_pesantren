 ...
 $(document).ready(function(){
   ...
   $(".hapus").click(function (e) {
    ...
    $.confirm({
        ...
        buttons: {
            hapus: {
                ...
                btnClass: 'btn-green',
                action: function(){
                    window.location.assign("<?php echo base_url() ?>admin/perizinansantriwati/santriwatihapus?nis="+v_nis);
                }
            },
            batal: function () {
    ...
    $('#provinsi').change(function(){
        var id=$(this).val();
        $.ajax({
        url : "<?php echo base_url();?>admin/perizinansantriwati/datakotakab2",
        method : "POST",
        data : {provinsi: id},
        async : false,
        dataType : 'json',
    ...
    $('#kabupaten_kota').change(function(){
        var id=$(this).val();
        $.ajax({
        url : "<?php echo base_url();?>admin/perizinansantriwati/datakecamatan2",
        method : "POST",
        data : {kecamatan: id},
        async : false,
        dataType : 'json',
    ...
    $('#kecamatan').change(function(){
        var id=$(this).val();
        $.ajax({
        url : "<?php echo base_url();?>admin/perizinansantriwati/datadesa2",
        method : "POST",
        data : {desa: id},
        async : false,
        dataType : 'json',
