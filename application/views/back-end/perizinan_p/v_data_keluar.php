                        ...
                        echo "
                          <tr class='rowData'>
                            ...
                            <td>
                              ...
                              <a href='".base_url('admin/perizinansantriwati/cetak_suratizin?id='.$row['id_keluar'].'')."' class='btn btn-success btn-xs' title='Cetak Surat Izin'><i class='fa fa-print'></i></a>
