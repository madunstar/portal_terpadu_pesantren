          ...
          <section class="panel panel-default">
                      ...
                      foreach($data->result_array() as $row){
                        echo "
                          <tr class='rowData'>
                            ...
                            <td>
                              <a href='".base_url('admin/perizinansantriwati/cetak_suratizin?id='.$row['id_keluar'].'')."' class='btn btn-primary btn-xs' title='Cetak Surat Izin'><i class='fa fa-print'></i></a>
            ...
            <div class="panel-footer">
              ...
              <div class='modal' id='cetaklap' tabindex='-1' role='dialog'>
                <form class='form-horizontal' role='form' data-validate='parsley' action='<?php echo base_url() ?>admin/perizinansantriwati/laporankeluar' method='post'>
