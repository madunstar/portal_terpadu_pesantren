...
<body class="" >
  ...
  <header class="bg-dark header header-md navbar navbar-fixed-top-xs box-shadow">
    <div class="navbar-header aside-md dk">
      ...
      <a href="<?php echo base_url() ?>admin/santriakd" class="navbar-brand">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu animated fadeInRight">
          ...
          <li>
            ...
            <a href="<?php echo base_url('admin/santriakd/ubahsandiadmin?nama_akun='.$nama_akun);?>">Ubah Kata Sandi </a>
          </li>
          <li class="divider"></li>
          <li>
            <a href="<?php echo base_url() ?>admin/santriakd/logout"><span class="fa fa-sign-out"></span>&nbsp;Keluar</a>
          </li>
        </ul>
      </li>
    </ul>
