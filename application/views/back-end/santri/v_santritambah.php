        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input type="text" class="form-control"  name="nik" data-required="true" value="<?php echo set_value('nik'); ?>"/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input type="text" class="form-control"  name="email_santri" value="<?php echo set_value('email_santri'); ?>"/>
              </div>
            </div>
            <div class="form-group">
