...
class Datamaster extends CI_Controller{
    ...
    function santriwatihapus()
    {
       ...
       redirect(base_url()."admin/datamaster/santriwati?msg=1");
    }
    ...
    function santriwatiedit()
    {
        if ($this->input->post()) {
            ...
            if (($this->m_santriwati->cekdata($nis)>0) && ($nis2!=$nis)) {
                ...
                $this->layout->render('back-end/datamaster/santriwati/v_santri_edit',$variabel,'back-end/datamaster/santriwati/v_santri_js');
            } else {
                $config['upload_path'] = './assets/images/foto';
                ...
                if ($exec){
                  redirect(base_url("admin/datamaster/santriwatiedit?nis=".$nis."&msg=1"));
                }
            }
      } else {
            $nis = $this->input->get("nis");
...
///////////////////////////////////////////memulai presensi////////////////////////////////////////////////
   ...
   function datarekapsantriwati(){
     if ($this->input->post()){
       ...
       if ($tgl > $today){
         redirect(base_url("admin/datamaster/datarekapsantriwati?kelas=$kel&pelajaran=$pel&tanggal=$today&psn=0"));
       } else{
       $this->layout->render('back-end/presensi_p/rekap_presensi/v_data_rekap',$variabel,'back-end/presensi_p/rekap_presensi/v_rekap_js');}
     } else {
     ...
     $variabel['matpel'] = $this->m_rekap_santriwati->pelajaran($pel);
     $variabel['namakelas'] = $this->m_rekap_santriwati->kelas($kel);
     $this->layout->render('back-end/presensi_p/rekap_presensi/v_data_rekap',$variabel,'back-end/presensi/rekap_presensi/v_rekap_js');}
   }

   function tambahrekapp(){
     if ($this->input->post()){
       $array = array(
     ...
     if ($exec){
       redirect(base_url("admin/datamaster/datarekapsantriwati?kelas=$kel&pelajaran=$pel&tanggal=$tgl&msg=1"));
     } else{
       redirect(base_url("admin/datamaster/datarekapsantriwati?kelas=$kel&pelajaran=$pel&tanggal=$tgl&msg=2"));
     }
     }
   }

   function hapusrekapp(){
     $id_rekap = $this->input->get('id');
     $tgl = $this->input->get('tanggal');
     $kel = $this->input->get('kelas');
     $pel = $this->input->get('pelajaran');
     $exec = $this->m_rekap_santriwati->hapus($id_rekap);
     redirect(base_url("admin/datamaster/datarekapsantriwati?kelas=$kel&pelajaran=$pel&tanggal=$tgl&psn=1"));
   }

   function laporanrekapharianp(){
     $tgl = $this->input->get('tanggal');
     $kel = $this->input->get('kelas');
     $pel = $this->input->get('pelajaran');
     $variabel['data'] = $this->m_rekap_santriwati->datakelas($kel,$pel,$tgl);
   ...
   function pondokanrekapp(){
     ...
     $this->layout->render('back-end/presensi_p/rekap_presensi_pondokan/v_data_pondokan',$variabel,'back-end/presensi_p/rekap_presensi_pondokan/v_rekap_js');
   }

   function datarekapsantripondokanp(){
     if ($this->input->post()){
       $today = date('Y-m-d');
       $tgl = $this->input->post('tanggal_rekap');
       $kel = $this->input->post('kelas');
       ...
       if ($tgl > $today){
         redirect(base_url("admin/datamaster/datarekapsantripondokanp?kelas=$kel&pelajaran=$pel&tanggal=$today&psn=0"));
       } else{
       $this->layout->render('back-end/presensi_p/rekap_presensi_pondokan/v_data_rekap_pondokan',$variabel,'back-end/presensi_p/rekap_presensi_pondokan/v_rekap_js');}
     } else {
     $tgl = $this->input->get('tanggal');
     $kel = $this->input->get('kelas');
     $pel = $this->input->get('pelajaran');
   ...
   function hapusrekappondokanp(){
     $id_rekap = $this->input->get('id');
     $tgl = $this->input->get('tanggal');
     $kel = $this->input->get('kelas');
     $pel = $this->input->get('pelajaran');
     $exec = $this->m_rekap_santri_pondokan_p->hapus($id_rekap);
     redirect(base_url("admin/datamaster/datarekapsantripondokanp?kelas=$kel&pelajaran=$pel&tanggal=$tgl&psn=1"));
   }

   function tambahrekappondokanp(){
     if ($this->input->post()){
       $array = array(
         'id_santri' => $this->input->post('nis'),
         'id_pelajaran' => $this->input->post('pel'),
     ...
     if ($exec){
       redirect(base_url("admin/datamaster/datarekapsantripondokanp?kelas=$kel&pelajaran=$pel&tanggal=$tgl&msg=1"));
     } else{
       redirect(base_url("admin/datamaster/datarekapsantripondokanp?kelas=$kel&pelajaran=$pel&tanggal=$tgl&msg=2"));
     }
     }
   }

   function laporanrekapharianpondokanp(){
     $tgl = $this->input->get('tanggal');
     $kel = $this->input->get('kelas');
     $pel = $this->input->get('pelajaran');
     $variabel['data'] = $this->m_rekap_santri_pondokan_p->datakelas($kel,$pel,$tgl);
      ...
      if ($this->input->post()){
          ...
          if ($ceknis > 0){
              if ($id_penjemput=='Baru'){
                  ...
                  redirect('admin/datamaster/suratizin');
              }
              else{
            ...
            redirect(base_url("admin/datamaster/keluar?msgnis=0"));
          }
      }
  ...
  function bayardendahapus(){
    ...
    if ($exec){
      ...
      if ($totalbayar < $besardenda){
        ...
        $this->m_denda->editdenda($id_denda,$arrayupdate);
        redirect(base_url("admin/datamaster/riwayatbayardenda?nis=".$nis."&denda=".$id_denda."&hps=1"));
      } else redirect(base_url("admin/datamaster/riwayatbayardenda?nis=".$nis."&denda=".$id_denda."&hps=1"));
...
/////////////cowok///////////////
  ...
  function prestasisantriwati(){
    ...
    if ($exec->num_rows()>0){
      $variabel['santri'] = $exec->row_array();
      $variabel['data'] = $this->m_prestasi_p->lihatdata($nis);
      $this->layout->render('back-end/prestasi_pelanggaran/v_data_prestasi_p',$variabel,'back-end/prestasi_pelanggaran/prestasi_pelanggaran_js');
    } else {
      redirect(base_url("admin/datamaster/santriwati"));
    }
  }
  ...
  function tambahprestasip(){
    if($this->input->post()){
      ...
      $exec = $this->m_prestasi_p->tambahdata($array);
      if($exec){
        redirect(base_url("admin/datamaster/tambahprestasip?nis=$nis&msg=1"));
      } else{
        redirect(base_url("admin/datamaster/tambahprestasip?nis=$nis&msg=0"));
      }
    } else {
        $nis = $this->input->get('nis');
        $exec = $this->m_santriwati->lihatdatasatu($nis);
        $variabel['santri'] = $exec->row_array();
        $variabel['nis_santri'] = $nis;
        $this->layout->render('back-end/prestasi_pelanggaran/v_prestasi_tambah_p',$variabel,'back-end/prestasi_pelanggaran/prestasi_pelanggaran_js');
    }
  }
  function ubahprestasip(){
    if($this->input->post()){
      ...
      $exec = $this->m_prestasi_p->editdata($id,$array);
      if($exec){
        redirect(base_url("admin/datamaster/ubahprestasip?nis=$nis&id=$id&msg=1"));
      } else{
        redirect(base_url("admin/datamaster/ubahprestasip?nis=$nis&id=$id&msg=0"));
      }
    } else {
      $id = $this->input->get('id');
      $nis = $this->input->get('nis');
      $exec = $this->m_santriwati->lihatdatasatu($nis);
        if ($exec->num_rows()>0){
      $exec2 = $this->m_prestasi_p->ambildata($id);
      $variabel['santri'] = $exec->row_array();
      $variabel['data'] = $exec2->row_array();
      $this->layout->render('back-end/prestasi_pelanggaran/v_prestasi_ubah_p',$variabel,'back-end/prestasi_pelanggaran/prestasi_pelanggaran_js');
    } else{
      redirect(base_url("admin/datamaster/santriwati"));
    }
    }
  ...
  function hapusprestasip(){
    $id = $this->input->get("id");
    $nis = $this->input->get('nis');
    $exec = $this->m_prestasi_p->hapus($id);
    redirect(base_url()."admin/datamaster/prestasisantriwati?nis=$nis&msg=1");
  }
  ////////////end prestasi/////////
//////////////////pelanggaran////////////////////////
...
function pelanggaransantriwati(){
  ...
  if ($exec->num_rows()>0){
    $variabel['santri'] = $exec->row_array();
    $variabel['data'] = $this->m_pelanggaran_p->lihatdata($nis);
    $this->layout->render('back-end/prestasi_pelanggaran/v_data_pelanggaran_p',$variabel,'back-end/prestasi_pelanggaran/prestasi_pelanggaran_js');
  } else {
    redirect(base_url("admin/datamaster/santriwati"));
    }
  }
  ...
  function tambahpelanggaranp(){
    if($this->input->post()){
      ...
      $exec = $this->m_pelanggaran_p->tambahdata($array);
      if($exec){
        redirect(base_url("admin/datamaster/tambahpelanggaranp?nis=$nis&msg=1"));
      } else{
        redirect(base_url("admin/datamaster/tambahpelanggaranp?nis=$nis&msg=0"));
      }
    } else {
        $nis = $this->input->get('nis');
        $exec = $this->m_santriwati->lihatdatasatu($nis);
        $variabel['santri'] = $exec->row_array();
        $variabel['nis_santri'] = $nis;
        $this->layout->render('back-end/prestasi_pelanggaran/v_pelanggaran_tambah_p',$variabel,'back-end/prestasi_pelanggaran/prestasi_pelanggaran_js');
    }
  }
  ...
  function ubahpelanggaranp(){
    if($this->input->post()){
      ...
      $exec = $this->m_pelanggaran_p->editdata($id,$array);
      if($exec){
        redirect(base_url("admin/datamaster/ubahpelanggaranp?nis=$nis&id=$id&msg=1"));
      } else{
        redirect(base_url("admin/datamaster/ubahpelanggaranp?nis=$nis&id=$id&msg=0"));
      }
    } else {
      $id = $this->input->get('id');
      $nis = $this->input->get('nis');
      $exec = $this->m_santriwati->lihatdatasatu($nis);
        if ($exec->num_rows()>0){
      $exec2 = $this->m_pelanggaran_p->ambildata($id);
      $variabel['santri'] = $exec->row_array();
      $variabel['data'] = $exec2->row_array();
      $this->layout->render('back-end/prestasi_pelanggaran/v_pelanggaran_ubah_p',$variabel,'back-end/prestasi_pelanggaran/prestasi_pelanggaran_js');
    } else{
      redirect(base_url("admin/datamaster/santri"));
    }
    }
  ...
  function hapuspelanggaranp(){
    $id = $this->input->get("id");
    $nis = $this->input->get('nis');
    $exec = $this->m_pelanggaran_p->hapus($id);
    redirect(base_url()."admin/datamaster/pelanggaransantriwati?nis=$nis&msg=1");
  }
...
function aturkelaspondwati(){
    if ($this->input->post()){
        ...
        $variabel['guru']=$this->m_guru->lihatdata();
        $variabel['pondokan']=$this->m_pondokan->lihatdata();
        $this->layout->render('back-end/presensi/presensi_pondwati/v_presensi_atur',$variabel,'back-end/presensi/presensi_pondwati/v_preskelas_js');
    }
}
...
function editkelaspondwati()
    {
        if ($this->input->post()) {
            ...
            if ($exec->num_rows()>0){
                ...
                $variabel['pondokan']=$this->m_pondokan->lihatdata();
                $variabel['tingkatan']=$this->m_pondokan->lihatdatatingkatan($variabel['data']['pondokan']);
                $this->layout->render('back-end/presensi/presensi_pondwati/v_presensi_edit',$variabel,'back-end/presensi/presensi_pondwati/v_preskelas_js');
            } else {
    ...
    function lihatkelaspondwati()
    {
        ...
        if ($exec->num_rows()>0){
            ...
            $this->layout->render('back-end/presensi/presensi_pondwati/v_presensi_lihat',$variabel,'back-end/presensi/presensi_pondwati/v_preskelas_js');
        } else {
            redirect(base_url("admin/datamaster/datakelaspondwati"));
        }
    }
    function kelaseditpondwati()
    {
        ...
        $this->load->view("back-end/presensi/presensi_pondwati/v_presensi_editstatus",$variabel);
    ...
    function lihatkelaspondokansantriwati()
    {
        ...
        if ($exec->num_rows()>0){
            ...
            $this->layout->render('back-end/presensi/presensi_pondwati/v_santri',$variabel,'back-end/presensi/presensi_pondwati/v_santri_js');
        } else {
            redirect(base_url("admin/datamaster/datakelaspondwati"));
        }
    }
    ...
    function kelastambahsantripondwati()
    {
        ...
        $this->load->view("back-end/presensi/presensi_pondwati/v_santri_tambah",$variabel);
    }
    ...
    function kelaseditsantripondwati()
    {
        ...
        $this->load->view("back-end/presensi/presensi_pondwati/v_santri_edit",$variabel);
    }
    ...
    function jadwalpondwati()
    {
        ...
        if ($exec->num_rows()>0) {
            ...
            $this->layout->render('back-end/presensi/presensi_pondwati/v_jadwal',$variabel,'back-end/presensi/presensi_pondwati/v_jadwal_js');
        } else {
            redirect(base_url("admin/datamaster/datakelaspondwati"));
        }
    }
    ...
    function tambahjadwalpondwati()
    {
        ...
        $variabel['pelajaran'] = $this->m_pelajaran->lihatdata();
        $variabel['jam'] = $this->m_pak_pondokan->lihatdata();
        $this->load->view("back-end/presensi/presensi_pondwati/v_jadwal_tambah",$variabel);
    }
    ...
    function editjadwalpondwati()
    {
        ...
        $this->load->view("back-end/presensi/presensi_pondwati/v_jadwal_edit",$variabel);
    }
...
function printkelaspondwati(){
    ...
    if ($exec->num_rows()>0) {
        ...
        $variabel['bulan'] = array ('Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember');
        $variabel['id'] = $id;
        $this->layout->render('back-end/presensi/presensi_pondwati/v_presensi_print',$variabel,'back-end/presensi/presensi_pondwati/v_presensi_printjs');
    } else {
        redirect(base_url("admin/datamaster/datakelaspondwati"));
    }
}
...
function printjadwalpondwati(){
    ...
    $this->layout->renderlaporan('back-end/presensi/presensi_pondwati/v_presensi_printjadwal',$variabel,'back-end/presensi/presensi_pondwati/v_presensi_printjadwal_js');
  }
...
function datakelasbelawati()
   ...
   function aturkelasbelawati(){
        if ($this->input->post()){
            ...
            $variabel['guru']=$this->m_guru->lihatdata();
            $variabel['jenjang']=$this->m_jenjang->lihatdata();
            $this->layout->render('back-end/presensi/presensi_kelwati/v_presensi_atur',$variabel,'back-end/presensi/presensi_kelwati/v_preskelas_js');
        }
   }
   ...
   function hapuskelasbelawati()
    ...
    function editkelasbelawati()
    {
        if ($this->input->post()) {
            ...
            if ($exec->num_rows()>0){
                ...
                $variabel['jenjang']=$this->m_jenjang->lihatdata();
                $variabel['tingkatan']=$this->m_jenjang->lihatdatatingkatan($variabel['data']['jenjang']);
                $this->layout->render('back-end/presensi/presensi_kelwati/v_presensi_edit',$variabel,'back-end/presensi/presensi_kelwati/v_preskelas_js');
            } else {
    ...
    function lihatkelasbelawati()
    {
        ...
        if ($exec->num_rows()>0){
            ...
            $this->layout->render('back-end/presensi/presensi_kelwati/v_presensi_lihat',$variabel,'back-end/presensi/presensi_kelwati/v_preskelas_js');
        } else {
            redirect(base_url("admin/datamaster/datakelasbelawati"));
        }
    }
    ...
    function lihatkelasbelajarsantriwati()
    {
        ...
        if ($exec->num_rows()>0){
            ...
            $this->layout->render('back-end/presensi/presensi_kelwati/v_santri',$variabel,'back-end/presensi/presensi_kelwati/v_santri_js');
        } else {
            redirect(base_url("admin/datamaster/datakelasbelajar"));
        }
    }
    ...
    function kelastambahsantriwati()
    {
        ...
        $this->load->view("back-end/presensi/presensi_kelwati/v_santri_tambah",$variabel);
    ...
    function kelaseditsantriwati()
    {
        ...
        $this->load->view("back-end/presensi/presensi_kelwati/v_santri_edit",$variabel);
    ...
    function kelaseditbelawati()
    {
        ...
        $this->load->view("back-end/presensi/presensi_kelwati/v_presensi_editstatus",$variabel);
    ...
    function jadwalafiwati()
    {
        ...
        if ($exec->num_rows()>0) {
            ...
            $this->layout->render('back-end/presensi/presensi_kelwati/v_jadwal',$variabel,'back-end/presensi/presensi_kelwati/v_jadwal_js');
        } else {
            redirect(base_url("admin/datamaster/datakelasbelawati"));
        }
    }
    ...
    function tambahjadwalafiwati()
    {
        ...
        $variabel['pelajaran'] = $this->m_pelajaran->lihatdata();
        $variabel['jam'] = $this->m_pak_afilasi->lihatdata();
        $this->load->view("back-end/presensi/presensi_kelwati/v_jadwal_tambah",$variabel);
    }
    ...
    function editjadwalafiwati()
    {
        ...
        $this->load->view("back-end/presensi/presensi_kelwati/v_jadwal_edit",$variabel);
    ...
    function printkelasafiwati(){
        ...
        if ($exec->num_rows()>0) {
            ...
            $variabel['bulan'] = array ('Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember');
            $variabel['id'] = $id;
            $this->layout->render('back-end/presensi/presensi_kelwati/v_presensi_print',$variabel,'back-end/presensi/presensi_kelwati/v_presensi_printjs');
        } else {
            redirect(base_url("admin/datamaster/datakelasbelajar"));
        }
    }
    ...
    function printjadwalafiwati(){
        ...
        $this->layout->renderlaporan('back-end/presensi/presensi_kelwati/v_presensi_printjadwal',$variabel,'back-end/presensi/presensi_kelwati/v_presensi_printjadwal_js');
      }
