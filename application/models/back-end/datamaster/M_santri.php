      ...
      public function listsantriajax()
        {
            ...
            $columns = array(
                // datatable column index  => database column name
                    0=>'tb_santri.nis_lokal',
                    1=>'tb_santri.nama_lengkap',
                    2=> 'tb_santri.nisn',
                    3=> 'tb_santri.gender'
            );
            $sql = "SELECT * ";
            $sql.=" FROM tb_santri WHERE 1=1 ";
            ...
            foreach($query->result_array() as $row) {  // preparing an array
                ...
                $akd = " <a href='".base_url('admin/datamaster/santrilihat?nis='.$row['nis_lokal'].'')."' class='btn btn-primary btn-xs' title='Lihat'><i class='fa fa-eye'></i></a>
                <a href='".base_url('admin/datamaster/santriedit?nis='.$row['nis_lokal'].'')."' class='btn btn-warning btn-xs' title='Ubah'><i class='fa fa-edit'></i></a>
                ...
                <a href='".base_url('admin/datamaster/detailinfaq?nis='.$row['nis_lokal'].'')."' class='btn btn-primary btn-xs' title='Detail Bayar Infaq'><i class='fa fa-money'></i></a>";
                $data[] = $nestedData;
                $no++;
            }
            $json_data = array(
