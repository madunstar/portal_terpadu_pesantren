 ...
 * www.crudigniter.com
 */
class m_rekap_guru_pondokan extends CI_Model
{
    ...
    //     $this->db->join('tb_presensi_pondokan', 'tb_presensi_jadwal_afilasi.id_kelas_belajar = tb_presensi_pondokan.id_kelas_belajar');
    ...
    function rekapguru($pel,$kel)
    {
      ...
      $this->db->join('tb_presensi_pondokan', 'tb_presensi_rekap_guru.id_kelas = tb_presensi_pondokan.id_kelas_belajar');
      $this->db->join('tb_mata_pelajaran', 'tb_pelajaran.id_mata_pelajaran = tb_mata_pelajaran.id_mata_pelajaran');
      $this->db->join('tb_guru', 'tb_pelajaran.nip_guru = tb_guru.nip_guru');
