   ...
   function hapusjadwal($id_jadwal)
    ...
    public function lihatdataajax()
    {
        ...
        foreach($query->result_array() as $row) {  // preparing an array
            ...
            $akd = " <a href='".base_url('admin/santriwatiakd/lihatkelaspondwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-primary btn-xs' title='Lihat'><i class='fa fa-eye'></i></a>
            <a href='".base_url('admin/santriwatiakd/editkelaspondwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-warning btn-xs' title='Edit'><i class='fa fa-edit'></i></a>
            <a href='#' class='btn btn-danger btn-xs hapus' title='Hapus' id='".$row['id_kelas_belajar']."'><i class='fa fa-trash-o'></i></a>
            <a href='".base_url('admin/santriwatiakd/printkelaspondwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-success btn-xs print' title='print' id='".$row['id_kelas_belajar']."'><i class='fa fa-print'></i></a>";
            $nestedData[] = $akd;
            ...
            $nestedData[] = "<a href='".base_url('admin/santriwatiakd/jadwalpondwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-primary btn-xs' title='Lihat'><i class='fa fa-clock-o'></i> Jadwal</a>";
            ...
            $nestedData[] = "<a href='".base_url('admin/santriwatiakd/lihatkelaspondokansantriwati?id='.$row['id_kelas_belajar'].'')."' class='btn btn-primary btn-xs' title='Lihat'><i class='fa fa-list'></i> Santri</a>";
            $data[] = $nestedData;
            $no++;
        }
        $json_data = array(
