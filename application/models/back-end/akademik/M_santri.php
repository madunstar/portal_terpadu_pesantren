      ...
      public function listsantriajax()
        {
            ...
            foreach($query->result_array() as $row) {  // preparing an array
                ...
                $akd = " <a href='".base_url('admin/santriakd/santrilihat?nis='.$row['nis_lokal'].'')."' class='btn btn-primary btn-xs' title='Lihat'><i class='fa fa-eye'></i></a>
                <a href='".base_url('admin/santriakd/santriedit?nis='.$row['nis_lokal'].'')."' class='btn btn-warning btn-xs' title='Ubah'><i class='fa fa-edit'></i></a>
